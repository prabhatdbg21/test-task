...
const lodash = require("276648992ed0b580");
let characters = [
    "a",
    "b",
    "c",
...
/* console.log(users.find(users, function(o) { return o.age < 40; })); */ _.countBy([
    6.1,
    4.2,
    6.3
], Math.floor);

},{"276648992ed0b580":"3qBDj","1fb38334b31ef719":"jwcsj"}],"3qBDj":[function(require,module,exports) {
var global = arguments[3];
(function() {
